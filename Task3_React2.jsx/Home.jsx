...
function Home() {
  const backgrounds = [
    { id: 1, src: "https://j.top4top.io/p_3727atiwv0.jpg" },
    { id: 2, src: "https://h.top4top.io/p_37273zity0.jpg" },
    { id: 3, src: "https://h.top4top.io/p_37276z5lb0.jpg" },
  ...
  return (
    ...
    <div style={{
        ...
        width:"100%",
        height:"100%",
        backgroundColor: lightMood ? "rgba(252, 246, 246, 0.08)" : "rgba(0, 0, 0, 0.6)",
        zIndex:-1
    }}>
